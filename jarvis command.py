...
def executing():
    ...
    while True:
        ...
        if "open notepad" in query:
            ...
            ip = get(
                'Go to ipify.org').text  # to find your IP address go to the ipifi,org and get your api and copy the link of your api key *Note- not copy the api key copy the link and paste here
